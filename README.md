...
[alphaperp.fun](https://alphaperp.fun) · [X / Twitter](https://x.com/alpha_perp) · [Pump.fun](https://pump.fun)
...
serve.ts · static.ts  lightweight static server (port 3456)
...
bun static.ts         # serve dist on http://0.0.0.0:3456   (or: bun dev)
```
...
Always verify the official $ALPERP contract address from our X account.

---

<div align="center">© 2026 AlphaPerp Labs · Live on Solana</div>
