...
serve.ts · static.ts  lightweight static server (port 3018)
...
bun static.ts         # serve dist on http://0.0.0.0:3018   (or: bun dev)
```
...
Always verify the official $AXPERP contract address from our X account.

---

<div align="center">© 2026 AXISPERP Labs · Live on Solana</div>
