    ...
    <footer className="footer rise">
      <div className="foot-top">
        <div className="foot-brand">
          ...
          <p>The permissionless perp engine on Solana. Launch markets, trade with 100× leverage, earn fees forever. Stop waiting — start printing.</p>
        ...
        <div className="foot-cols">
          ...
          <div className="foot-col">
            <h4>$AGPERP</h4>
            <a href={PUMPFUN_URL} target="_blank" rel="noreferrer">Buy $AGPERP</a>
      ...
      <div className="foot-bottom">
        <span>© 2026 AEGISPERP Labs · Live on Solana</span>
